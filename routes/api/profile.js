...
router.post(
  ...
  (req, res) => {
    ...
    profileFields.stage = req.body.stage;
    ...
    upload(req, res, (error) => {
      ...
      if (error){
        ...
        if (req.file === undefined){
          ...
          // let test = Profile.findOne({_id:req.params.id},  (err, message) => {
          //   res.json(data);
          // });console.log(test);
          Profile.findOneAndUpdate({user:req.params.id}, { cv:data }, {new:true}, (err, message) => {
            res.json(message);
          })
        }
      }
